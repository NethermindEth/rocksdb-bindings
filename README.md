...
Parts of the managed API are derived from [rocksdb-sharp](https://github.com/curiosity-ai/rocksdb-sharp), used under [BSD-2-Clause](https://github.com/curiosity-ai/rocksdb-sharp/blob/master/LICENSE).
